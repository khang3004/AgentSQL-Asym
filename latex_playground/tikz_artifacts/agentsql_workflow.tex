...
\begin{tikzpicture}[
    ...
    \node (sandbox) [decision, below=0.9cm of reflect]
        {\scriptsize Semantic \\[4pt] \scriptsize Validation};
    ...
    \begin{scope}[on background layer]
        ...
        \node[anchor=south west, font=\sffamily\bfseries\scriptsize,
              ...
              [yshift=4pt, xshift=4pt] at (offline_box.north west) {OFFLINE PRE-PROCESSING (zero API cost)};
        ...
        \node[anchor=north west, font=\sffamily\bfseries\scriptsize,
              ...
              [yshift=4pt, xshift=4pt] at (llm_box.north west) {ASYMMETRIC LLM LOOP ($\leq 3$ API calls)};
    \end{scope}
