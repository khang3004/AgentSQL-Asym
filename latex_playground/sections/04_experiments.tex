...
\begin{table}[t]
    ...
    \begin{tabular}{@{}lrrrr@{}}
        \toprule
        \textbf{Config.} & \textbf{EX} & \textbf{VES} & \textbf{F1} & \textbf{Lat. (s)} \\
        \midrule
...
\begin{table}[t]
    ...
    \begin{tabular}{@{}lrrrrr@{}}
        \toprule
        \textbf{Difficulty} & \textbf{N} & \textbf{EX} & \textbf{VES} & \textbf{F1} & \textbf{Lat. (s)} \\
        \midrule
...
\begin{table*}[t]
    ...
    \begin{minipage}{\textwidth}
        ...
        \begin{tabularx}{\textwidth}{@{}lcccccX@{}}
            ...
            \midrule
            \textbf{MAC-SQL} \cite{wang_mac-sql_2025} & No & No & No & 57.36 & 59.59 & Homogeneous agent pool (Llama/GPT-4), single-path execution. \\
            \textbf{CHESS} \cite{talaei_chess_2024} & No & Yes & Yes & 68.31 & 71.10 & Multi-agent with unit-test ranking (Gemini-1.5-Pro, high compute). \\
            \textbf{ReViSQL} \cite{zhu2026revisqlachievinghumanleveltexttosql} & No & Yes & Yes & 93.17\textsuperscript{\textdagger} & N/A & RLVR fine-tuned model; expert-cleaned Arcwise-Plat-SQL set (129 candidates). \\
            \textbf{AGENTIQL} \cite{heidari_agentiql_2025} & Yes & Yes & Yes & N/A\textsuperscript{\textdagger\textdagger} & N/A\textsuperscript{\textdagger\textdagger} & Test-time scaling via RL reasoning (evaluated on Spider only). \\
            \textbf{MCI-SQL} \cite{wang_mci-sql_2026} & No & Yes & Yes & 74.45 & 76.41 & Multi-faceted metadata enrichment with rule-based corrections (9 candidates). \\
            \textbf{Agentar-Scale-SQL} \cite{wang_agentar-scale-sql_2025} & Yes & Yes & Yes & 74.90 & 81.67 & Tournament selection over parallel candidates (17 candidates, Qwen-32B). \\
            \midrule
